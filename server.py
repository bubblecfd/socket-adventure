...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        # TODO: YOUR CODE HERE
        if room_number == 0:
            str = 'Room 0: you can rest here...'
        elif room_number == 1:
            str = 'Room 1: snake room, fight...'
        elif room_number == 2:
            str = 'Room 2: you found treasure...'
        elif room_number == 3:
            str = 'Room 3: tiger room, run...'
    ...
    def push_output(self):
        ...
        # TODO: YOUR CODE HERE
        response = "OK! " + self.output_buffer + "\n"
